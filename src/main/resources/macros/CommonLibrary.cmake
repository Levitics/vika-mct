...
function(common_library Name)
  ...
  # Generate Api.hpp and Version.hpp/cpp for non-interface libraries
  if(${NAME}_SOURCES)
    set(PROJECT_VERSION_ABI ${${PROJECT_NAME}_VERSION_ABI})
    configure_file(${CMAKE_SOURCE_DIR}/src/main/resources/Api.hpp
                   ${CMAKE_SOURCE_DIR}/core/src/main/cpp/didactics/core/Api.hpp @ONLY)
    ...
    # ${NAMESPACE}_API= -> Fix cppcheck error about not including Version.hpp
    list(APPEND CPPCHECK_EXTRA_ARGS
                -D${NAME}_STATIC= 
                -D${NAMESPACE}_API=)

    list(APPEND PUBLIC_HEADERS
        ${PROJECT_BINARY_DIR}/include/${INCLUDE_NAME}/Api.hpp
        ${PROJECT_BINARY_DIR}/include/${INCLUDE_NAME}/Version.hpp)
