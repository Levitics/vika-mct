...
public:
     ...
     * @param rhs
     */
    const Timestamp operator + (const Clocker & rhs) const;
     ...
     * @param rhs
     */
    Clocker operator += (const Clocker & rhs) = delete;
     ...
     * @param rhs
     */
    bool operator == (const Clocker & rhs) const;
     ...
     * @param rhs
     */
    bool isEqual (const Clocker & rhs) const;
