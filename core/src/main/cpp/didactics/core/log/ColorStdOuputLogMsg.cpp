...
ColorStdOuputLogMsg::ColorStdOuputLogMsg(bool useColor ,
                                         log4cxx::LogString dateFormat)
                                  ...
                                  log4cxx::helpers::Pool &              p) const
{
    ...
    if (!date.empty())
    {
        ...
        if (printLocation)
        {
            ...
            {
                output << "\n  -> "
                       << COLOR_TYPE[ColorStdOuputLogMsg::Yellow] << event->getLocationInformation().getFileName()
                                     ...
                                     const log4cxx::LogString & value)
{
    ...
    /*
       if(log4cxx::helpers::StringHelper::equalsIgnoreCase(option, LOG4CXX_STR("COLOR"), LOG4CXX_STR("color")))
       {
       ...
       if(log4cxx::helpers::StringHelper::equalsIgnoreCase(option, LOG4CXX_STR("PRINTLOCATION"), LOG4CXX_STR("printlocation")))
       {
