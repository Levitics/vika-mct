...
DelegateMockTurtle::DelegateMockTurtle()
    : logger (log4cxx::Logger::getLogger(std::string("diactics.core.exple.DelegateMockTurtle")))
{
...
void DelegateMockTurtle::DelegateToFake ()
{
    LOG4CXX_TRACE(logger , __LOG4CXX_FUNC__);
    ...
    ON_CALL(*this ,
            getArbitraryString()).WillByDefault(testing::Invoke(&turtleNinja , &FakeTurtle::getArbitraryString));
